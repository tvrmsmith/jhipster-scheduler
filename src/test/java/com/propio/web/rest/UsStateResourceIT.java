...
class UsStateResourceIT {
    ...
    void createUsState() throws Exception {
        ...
        // Create the UsState
        restUsStateMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(usState)))
    ...
    void putWithMissingIdPathParamUsState() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restUsStateMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(usState)))
    ...
    void patchWithMissingIdPathParamUsState() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restUsStateMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(usState)))
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteUsState() throws Exception {
        ...
        // Delete the usState
        restUsStateMockMvc
            .perform(delete(ENTITY_API_URL_ID, usState.getId()).accept(MediaType.APPLICATION_JSON))
