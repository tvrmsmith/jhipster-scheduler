...
class AddressResourceIT {
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address().line1(DEFAULT_LINE_1).line2(DEFAULT_LINE_2).city(DEFAULT_CITY);
        // Add required entity
        UsState usState;
        if (TestUtil.findAll(em, UsState.class).isEmpty()) {
            usState = UsStateResourceIT.createEntity(em);
            em.persist(usState);
            em.flush();
        } else {
            usState = TestUtil.findAll(em, UsState.class).get(0);
        }
        address.setState(usState);
        // Add required entity
        ZipCode zipCode;
        if (TestUtil.findAll(em, ZipCode.class).isEmpty()) {
            zipCode = ZipCodeResourceIT.createEntity(em);
            em.persist(zipCode);
            em.flush();
        } else {
            zipCode = TestUtil.findAll(em, ZipCode.class).get(0);
        }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address().line1(UPDATED_LINE_1).line2(UPDATED_LINE_2).city(UPDATED_CITY);
        // Add required entity
        UsState usState;
        if (TestUtil.findAll(em, UsState.class).isEmpty()) {
            usState = UsStateResourceIT.createUpdatedEntity(em);
            em.persist(usState);
            em.flush();
        } else {
            usState = TestUtil.findAll(em, UsState.class).get(0);
        ...
        ZipCode zipCode;
        if (TestUtil.findAll(em, ZipCode.class).isEmpty()) {
            zipCode = ZipCodeResourceIT.createUpdatedEntity(em);
            em.persist(zipCode);
            em.flush();
        } else {
            zipCode = TestUtil.findAll(em, ZipCode.class).get(0);
    ...
    void putNewAddress() throws Exception {
        ...
        updatedAddress.line1(UPDATED_LINE_1).line2(UPDATED_LINE_2).city(UPDATED_CITY);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.line1(UPDATED_LINE_1).city(UPDATED_CITY);
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.line1(UPDATED_LINE_1).line2(UPDATED_LINE_2).city(UPDATED_CITY);
